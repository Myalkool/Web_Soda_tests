    ...
    if request.method == 'POST':
        ...
        if validate_test_structure(test_str):
            if create_test_file(test_str):
                ...
                if raw_result:
                    success_count, fail_count, error_count, count = 0, 0, 0, 0
                    ...
                    for result in parsed_result:
                        if result['status'] == 'success':
                            ...
                            error_count += 1
                        count += 1
                    return render_template("result.html", results=parsed_result, success_count=success_count,fail_count=fail_count, error_count=error_count, bck_btn='/home')
